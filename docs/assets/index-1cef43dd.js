...
function useHttp(url, config, initData) {
  const [isLoading, setIsLoading] = reactExports.useState(false);
  const [data, setData] = reactExports.useState(initData);
  const [error, setError] = reactExports.useState();
  function resetData() {
    setData(initData);
  }
  const sendRequest = reactExports.useCallback(
    async function sendRequest2(data2) {
      setIsLoading(true);
      try {
        ...
        setError(error2.message || `Something get wrong`);
      }
      setIsLoading(false);
    },
    [url, config]
...
const REST_URL = "https://www.julie-danjou.com/food_order";
...
function cartReducer(state, action) {
  ...
  switch (action.type) {
    case "ADD_MEAL":
      ...
      if (isAddedIndex > -1) {
        const existingMeal2 = state.cart[isAddedIndex];
        const updatedMeal = {
          ...existingMeal2,
          quantity: existingMeal2.quantity + 1
        };
...
function CartContextProvider({ children }) {
  const [userCart, dispatch] = reactExports.useReducer(cartReducer, {
    cart: []
  });
  ...
  function removeMeal(id2) {
    dispatch({ type: "REMOVE_MEAL", id: id2 });
  }
  function resetCart() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CartContext.Provider, { value: cartContext, children });
}
const UserProgressContext = reactExports.createContext({
  progress: "",
  showCart: () => {
  },
  hideCart: () => {
...
function UserProgressContextProvider({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(UserProgressContext.Provider, { value: userProgressContext, children });
}
function Modal({
  children,
  isOpen,
  ...
  const dialog = reactExports.useRef();
  reactExports.useEffect(() => {
...
function Input({ label, id: id2, ...props }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "control", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: id2, children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("input", { id: id2, name: id2, ...props })
  ] });
}
function Button({
  children,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: cssClasses, ...props, children });
}
function Error$1({ title, message }) {
...
function Checkout({}) {
  ...
  const userProgressContext = reactExports.useContext(UserProgressContext);
  const {
    data: meals,
    isLoading,
    error,
    sendRequest,
    resetData
  } = useHttp(`${REST_URL}/orders`, httpConfig$1);
  ...
  let cta = /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "modal-actions", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { textOnly: true, type: "button", onClick: handleClose, children: "Close" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { children: "Submit Order" })
  ] }) });
  if (isLoading) {
    cta = /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "modal-actions", children: [
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Sending order..." })
    ] }) });
  }
  if (error) {
    cta = /* @__PURE__ */ jsxRuntimeExports.jsx(Error$1, { title: "Failed to send order", message: error });
  }
  if (meals && meals.message && !error) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Modal,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Success!" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Your order was send. The delivery will take 30mn." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Thank you for your order!" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: handleCloseOrder, children: "Close" })
        ]
      }
    );
  }
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            "Total Amount: ",
            setPrice(getTotal(cartContext.cart))
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { label: "Full Name", id: "name", type: "text", required: true }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { label: "Email Adress", id: "email", type: "email", required: true }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { label: "Street", id: "street", type: "text", required: true }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "control-row", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { label: "Postal Code", id: "postal-code", type: "text", required: true }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { label: "City", id: "city", type: "text", required: true })
          ] }),
          cta
        ] })
      ]
...
function Header({ sitename }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { id: "main-header", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "title", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo, alt: "React Food logo" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: sitename })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "cart-item-actions", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Button,
      {
        textOnly: true,
...
function Meal({ meal }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "meal-item", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: `${REST_URL}/${meal.image}`, alt: meal.name }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: meal.name }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "meal-item-price", children: setPrice(meal.price) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "meal-item-description", children: meal.description })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "meal-item-actions", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: handleAddMeal, children: "Add to cart" }) })
  ] }) });
}
const httpConfig = {
  method: "GET"
...
function Meals() {
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "center", children: "Fetching meals..." });
  }
  if (error) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Error$1, { title: "Failed to fetch meals", message: error });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "meals", children: meals.map((meal) => {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Meal, { meal }, meal.id);
  }) });
}
function ModalCart({}) {
  const cartContext = reactExports.useContext(CartContext);
  ...
  if (cartContext.cart.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Modal,
      {
        ...
        onCloseHandler: userProgressContext.progress === "cart" ? handleCloseModal : null,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "You cart is currently empty." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "modal-actions", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { textOnly: true, onClick: handleCloseModal, children: "Close" }) })
        ]
      }
    );
  }
      ...
      children: [
        cartContext.cart.map((item) => {
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cart-item", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: `${item.name} - ${item.quantity} x ${setPrice(item.price)}` }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cart-item-actions", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => cartContext.removeMeal(item.id), children: "-" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: item.quantity }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => cartContext.addMeal(item), children: "+" })
            ] })
          ] }, item.id);
        }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "modal-actions", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { textOnly: true, onClick: handleCloseModal, children: "Close" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: handleGoToCheckout, children: "Go to checkout" })
        ] })
      ]
    }
  );
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(UserProgressContextProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CartContextProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { sitename: "ReactFood" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Meals, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ModalCart, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Checkout, {})
  ] }) }) });
}
const index = "";
